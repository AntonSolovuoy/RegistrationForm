					...
					<div className="col-lg-8 col-md-8 col-sm-10 col-xs-10">
						...
						<form className="form-horizontal">
							...
							<div className="form-group">
								...
								<form className="col-lg-5 col-md-3 col-sm-3 col-xs-12" onSubmit={this.buttonChangeLogIN}>
									<button type="submit" className="btn btn-danger navbar-btn btn-block">Log IN</button>
								</form>
